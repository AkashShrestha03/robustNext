...
const FourSet = () => {
  ...
  const [subcategoryName, setSubcategoryName] = useState("4 Pcs Combo Set");
    ...
    const getProduct = async () => {
      try {
        const res = await axios.get(
          `https://spice-13.onrender.com/api/product/Sub/Category/Product/List?SubCategoryID=67348eb6d064e0667e11c8c7`
        );
  ...
  const fetchSortedProducts = async (order) => {
    try {
      const res = await axios.get(
        `https://spice-13.onrender.com/api/product/Sort/Product?price=${order}&SubCategoryID=67348eb6d064e0667e11c8c7`
      );
      setProducts(res?.data?.data);
    } catch (error) {
