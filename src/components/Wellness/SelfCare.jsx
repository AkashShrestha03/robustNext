...
const SelfCare = () => {
  ...
  const [subcategoryName, setSubcategoryName] = useState("Self Care");
    ...
    const getProduct = async () => {
      try {
        const res = await axios.get(
          `https://spice-19.onrender.com/api/product/Sub/Category/Product/List?SubCategoryID=66e95381e4a0682d9adf6a0e`
        );
  ...
  const fetchSortedProducts = async (order) => {
    try {
      const res = await axios.get(
        `https://spice-19.onrender.com/api/product/Sort/Product?price=${order}&SubCategoryID=66e95381e4a0682d9adf6a0e`
      );
