...
const AllWelness = () => {
  ...
  const [categoryName, setCategoryName] = useState("Wellness");
    ...
    const getProduct = async () => {
      try {
        const res = await axios.get(
          `https://spice-19.onrender.com/api/product/Category/Product/List?CategoryID=66e95381e4a0682d9adf6a0c`
        );
  ...
  const fetchSortedProducts = async (order) => {
    try {
      const res = await axios.get(
        `https://spice-19.onrender.com/api/product/Sort/Product?price=${order}&CategoryID=66e95381e4a0682d9adf6a0c`
      );
