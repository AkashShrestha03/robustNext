...
const Laptop = () => {
  ...
  const [subcategoryName, setSubcategoryName] = useState("Laptop Bags");
    ...
    const getProduct = async () => {
      try {
        const res = await axios.get(
          `https://spice-13.onrender.com/api/product/Sub/Category/Product/List?SubCategoryID=673efed25a3f15fd938660f6`
        );
  ...
  const fetchSortedProducts = async (order) => {
    try {
      const res = await axios.get(
        `https://spice-13.onrender.com/api/product/Sort/Product?price=${order}&SubCategoryID=673efed25a3f15fd938660f6`
      );
