...
const Duffle = () => {
  ...
  const [subcategoryName, setSubcategoryName] = useState("Duffle Bags");
    ...
    const getProduct = async () => {
      try {
        const res = await axios.get(
          `https://spice-19.onrender.com/api/product/Sub/Category/Product/List?SubCategoryID=673efb645a3f15fd938660e0`
        );
  ...
  const fetchSortedProducts = async (order) => {
    try {
      const res = await axios.get(
        `https://spice-19.onrender.com/api/product/Sort/Product?price=${order}&SubCategoryID=673efb645a3f15fd938660e0`
      );
